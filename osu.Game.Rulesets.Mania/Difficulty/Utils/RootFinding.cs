...
namespace osu.Game.Rulesets.Mania.Difficulty.Utils
{
    public static class RootFinding
    {
        ...
        /// <param name="maxIterations">The maximum number of iterations before the function gives up.</param>
        ...
        public static double FindRootExpand(Func<double, double> function, double guessLowerBound, double guessUpperBound, int maxIterations = 25, double accuracy = 1e-6D)
        {
            ...
            while (fa * fb > 0)
            {
                ...
                if (++expansions > max_expansions)
                    throw new ArgumentOutOfRangeException(nameof(guessUpperBound), "The root could not be bracketed.");
            }
            ...
            for (int i = 0; i < maxIterations; i++)
            {
                ...
                bool inverseQuadratic = phi * phi < chi && (1 - phi) * (1 - phi) < chi;
